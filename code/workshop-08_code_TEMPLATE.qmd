...
drought_exp_clean <- drought_exp |> # starting with drought_exp object
  ...
  # making sure species_name is a factor and ordering levels
...
AICc(model0,
     ...
     model2,
     model3,
     model4, #best model: water treamtnet and species
     model5,
     model6,
     model7) |> 
  #arranging output in decending order of AIC
arrange(AICc)
```
...
#refrence level for species: Lotus scoparius
```
...
On average, plant masses in drought stressed conditions were 0.12 $\pm$ 0.02 g less than plant masses in weel watered conditions across species

Across water treatments, all speciesis have different (and higher) plant masses than lotus scorparous excepts penstemon cerranthidoluis
